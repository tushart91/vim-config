...
autocmd bufnewfile /windows/Users/tushart91/Downloads/Dropbox/Study/*.txt exe "1," . 7 . "g/date :.*/s//date\t\t" .strftime("%Y-%m-%d")

autocmd bufnewfile /windows/Users/tushart91/Downloads/Dropbox/Study/*.py so ~/Documents/python-header.txt
